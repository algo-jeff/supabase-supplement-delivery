          ...
          <div className="px-6 py-4">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">영양제 배송 현황을 관리하세요</p>
              </div>
              <button 
        ...
        <main className="p-6">
          ...
          <div className="bg-white rounded-lg shadow">
            <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0">
                ...
                <div className="flex md:hidden">
                  <button
                    ...
                    className="px-3 py-2 bg-gray-200 text-gray-700 rounded-md text-sm font-medium hover:bg-gray-300 transition-colors duration-200 flex items-center space-x-1"
                  >
              ...
              {/* 모바일용 필터 패널 */}
              {showMobileFilters && (
                <div className="md:hidden mt-4 p-4 bg-white border border-gray-200 rounded-lg">
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between mt-4">
                      <button
                        type="button"
                        onClick={resetFilters}
                        className="px-4 py-2 bg-gray-200 text-gray-700 rounded-md text-sm font-medium hover:bg-gray-300 transition-colors duration-200"
                      >
                        필터 초기화
                      </button>
                      <button
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      <th scope="col" onClick={() => handleSort('id')} className="cursor-pointer hover:bg-gray-100 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        <div className="flex items-center">
                          ID
                          {sortConfig.key === 'id' && (
                      ...
                      <th scope="col" onClick={() => handleSort('recipient_name')} className="cursor-pointer hover:bg-gray-100 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        <div className="flex items-center">
                          수령인
                      ...
                      <th scope="col" onClick={() => handleSort('delivery_date')} className="cursor-pointer hover:bg-gray-100 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        <div className="flex items-center">
                          배송일
                      ...
                      <th scope="col" onClick={() => handleSort('supplement_type')} className="cursor-pointer hover:bg-gray-100 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden sm:table-cell">
                        <div className="flex items-center">
                          영양제 종류
                      ...
                      <th scope="col" onClick={() => handleSort('quantity')} className="cursor-pointer hover:bg-gray-100 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden sm:table-cell">
                        <div className="flex items-center">
                          수량
                      ...
                      <th scope="col" onClick={() => handleSort('is_send')} className="cursor-pointer hover:bg-gray-100 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        <div className="flex items-center">
                          상태
                      ...
                      <th scope="col" onClick={() => handleSort('invoice_number')} className="cursor-pointer hover:bg-gray-100 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden sm:table-cell">
                        <div className="flex items-center">
                          송장번호
                    ...
                    {filteredDeliveries.map((delivery, idx) => {
                      ...
                      return (
                        <tr key={delivery.id} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{delivery.recipient_name}</td>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 hidden sm:table-cell">{delivery.supplement_type}</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-center hidden sm:table-cell">{delivery.quantity}</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <button
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 hidden sm:table-cell">{delivery.invoice_number || '-'}</td>
